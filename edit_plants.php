...
// Fetch plant and inventory info with category and supplier
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $inv_quantity = (int)$_POST['inv_quantity']; // Changed from 'quantity' to 'inv_quantity'
    ...
    if ($stmt->execute()) {
        ...
        if ($supplierID) {
            ...
            $stmtInventory->bind_param("iii", $plantID, $inv_quantity, $supplierID); // Changed $quantity to $inv_quantity
...
<!-- HTML and CSS Below Are Unchanged -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
